    ...
    <main class="main-content">
      <div class="page-content p-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h1 class="mb-0" id="order-title">Chi tiết Đơn hàng</h1>
        ...
        <div class="row g-4">
          <div class="col-lg-8">
            <div class="card order-detail-card">
              <div class="card-header"><h3 class="h5 mb-0">Sản phẩm</h3></div>
              <div class="card-body">
                <table class="table align-middle">
                  <tbody id="product-items-table"></tbody>
                </table>
          ...
          <div class="col-lg-4">
            <div class="card mb-4">
              <div class="card-header"><h3 class="h5 mb-0">Khách hàng</h3></div>
