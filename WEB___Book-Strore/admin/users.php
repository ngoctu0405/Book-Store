    ...
    <main class="main-content">
      <div class="page-content p-4">
        ...
        <div class="card">
          ...
          >
            <h3 class="h5 mb-0">Danh sách khách hàng</h3>
        ...
        <div class="modal-content">
          <form id="addUserForm">
            ...
            <div class="modal-body">
              <div class="mb-3">
                <label for="add-fullName" class="form-label">Họ và tên</label>
                <input
                  type="text"
                  class="form-control"
                  id="add-fullName"
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <label for="add-password" class="form-label"
                    >Mật khẩu (tối thiểu 6 ký tự)</label
                  >
                  <input
                    type="text"
                    class="form-control"
